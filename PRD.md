...
| BODY-06 | 提供刪除身材紀錄功能，刪除前顯示確認 Dialog | P1 |
| BODY-07 | 在身材趨勢區塊顯示各項指標的折線趨勢圖，支援切換指標 | P1 |
...
| HIST-05 | 支援編輯訓練紀錄（日期、動作、組數、備註），以底部 Sheet 呈現 | P1 |
| HIST-06 | 支援刪除訓練紀錄，刪除前顯示確認 Dialog | P1 |
