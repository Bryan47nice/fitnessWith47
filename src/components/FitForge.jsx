...
export default function FitForge({ user }) {
  ...
  const presetNames = new Set(allPresetFlat.map(e => e.name));
  const allCustomFlat = customExercises
    .filter(e => !presetNames.has(e.name))
    .map(e => ({ name: e.name, category: e.category || "自訂", id: e.id }));
          ...
          <div style={{ padding: "8px 24px 20px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>修正訓練日誌卡片：動作名稱過長時按鈕不再縱向排列</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.18.6</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-26</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>修正動作分類篩選器顯示錯誤分類動作的問題</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.18.4</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-26</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>教練課日 day row emoji 動態化：全部自練時顯示 💪 而非 🏅，避免誤解</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.18.2</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-25</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>訓練日誌 UX 重構：移除重複當日紀錄卡片、日曆點擊連動歷史列表篩選、強化週/日折疊層級視覺</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.18.1</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-24</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>教練課項目標記改為雙狀態徽章（🏅 上課 / 💪 自練），切換時顯示 toast 提示</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.18.0</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-24</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>教練課動作庫新增三種瀏覽模式：全部動作、依課程時間（聚焦筆記）、依部位分類篩選</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.16.0</span>
                <span style={{ fontSize: "12px", color: "#555", marginLeft: "auto" }}>2026-04-20</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
                <div style={{ fontSize: "14px", color: "#c8c4bc", display: "flex", gap: "8px" }}>
                  <span style={{ color: "#ffd700", flexShrink: 0 }}>✨</span>
                  <span>儀表板新增本週 vs 上週訓練量對比卡片；目標接近達標（≥90%）顯示「快到了 🎯」橘色徽章</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                <span style={{ fontSize: "17px", fontWeight: 900, color: "#e8e4dc" }}>v1.15.2</span>
